    ...
    <div class="flex-1 flex flex-col pl-6 pr-4 py-2">
        ...
        <main class="flex-1 p-6 items-center overflow-auto">
            <div class="max-w-6xl ml-[250px]">
                <h1 class="text-2xl font-bold mb-6 text-center">Gestion des permissions</h1>

                <div class="flex items-center justify-between mb-4">
                    <form method="GET" action="{{ route('permissions.index') }}" class="flex items-center space-x-2">
                    ...
                    <a href="{{ route('permissions.create') }}" class="px-4 py-2 bg-purple-700 text-white rounded hover:bg-purple-600">Créer une permissions</a>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full border-collapse border border-gray-300">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="border border-gray-300 px-4 py-8 text-center text-gray-500">Aucune permission</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
