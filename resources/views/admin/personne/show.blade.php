        ...
        <main class="flex-1 p-6 items-center overflow-auto">
            <div class="max-w-4xl ml-[250px]">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    @if(optional($personne->etudiant)->inscriptions && $personne->etudiant->inscriptions->count())
                        <div class="mt-8">
                            <h2 class="text-lg font-semibold mb-3">Historique des inscriptions (Étudiant)</h2>
                            <div class="overflow-x-auto">
                                <table class="w-full border-collapse border border-gray-300">
                                    ...
                                    <tbody>
                                        @foreach($personne->etudiant->inscriptions as $ins)
